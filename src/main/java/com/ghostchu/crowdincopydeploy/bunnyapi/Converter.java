...
public class Converter {
    ...
    public static BCDNObject[] fromJsonString(final String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(final BCDNObject[] obj) throws JsonProcessingException {
